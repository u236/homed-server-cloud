...
#define TOKEN_EXPIRE_TIMEOUT    31536000    // one little year
...
private:
    ...
    bool m_debug;
    QByteArray m_path, m_clientId, m_clientSecret, m_skillId, m_skillToken, m_botHost, m_botToken, m_botSecret, m_userLogin, m_userPassword, m_rrdPath;
    quint32 m_apiCount, m_eventCount, m_clientCount, m_descriptorCount;
